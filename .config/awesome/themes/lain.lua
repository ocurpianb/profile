theme = {}
theme.wallpaper  = os.getenv("HOME")..'/.config/awesome/walls/lain_room.jpg'
theme.icon_theme = nil

-- {{{ Styles
theme.font          = "artwiz smoothansi 9"
theme.font_key      = "#FEFEFE"
theme.font_value    = "#E4E4E4"
--bg
theme.bg_normal     = "#010102AA"
theme.bg_focus      = "#FEFEFEAA"
theme.bg_urgent     = "red"
theme.bg_minimize   = "#E4E4E4"
--fg
